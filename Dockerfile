...
WORKDIR /opt/zig
RUN curl -sSLf -o - https://ziglang.org/builds/zig-linux-x86_64-0.10.0-dev.3685+dae7aeb33.tar.xz | tar xJf - --strip-component=1
...
RUN ./configure --prefix=${INSTALL_PREFIX} --enable-static \
    --host=${HOST} \
